...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			"tritonfa_account":        dataSourceAccount(),
			"tritonfa_datacenter":     dataSourceDataCenter(),
			"tritonfa_image":          dataSourceImage(),
			"tritonfa_network":        dataSourceNetwork(),
			"tritonfa_package":        dataSourcePackage(),
			"tritonfa_fabric_vlan":    dataSourceFabricVLAN(),
			"tritonfa_fabric_network": dataSourceFabricNetwork(),
		},

		ResourcesMap: map[string]*schema.Resource{
			"tritonfa_fabric":            resourceFabric(),
			"tritonfa_firewall_rule":     resourceFirewallRule(),
			"tritonfa_instance_template": resourceInstanceTemplate(),
			"tritonfa_key":               resourceKey(),
			"tritonfa_machine":           resourceMachine(),
			"tritonfa_service_group":     resourceServiceGroup(),
			"tritonfa_snapshot":          resourceSnapshot(),
			"tritonfa_vlan":              resourceVLAN(),
		},
